...
import com.example.firstproject.viewmodels.ProfileViewModel
...
val info = viewFields.filter { setOf("firstName","lastName","about","repository").contains(it.key) }
        ...
        with(btn_edit){
            ...
            val icon = if(isEdit){
                ...
                resources.getDrawable(R.drawable.ic_edit_24,theme)
            }
...
private fun saveProfileInfo(){
    Profile(
        ...
        repository = et_repos.text.toString(),
    ).apply {
